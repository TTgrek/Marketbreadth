...
def register_callbacks(app):
    ...
    def update_risk_page(pathname):
        if pathname == "/sector_leaders":
            return layout
        return html.H1("Sidan hittades inte")
...
layout = html.Div([
    ...
    html.Div([html.Button(interval, id=f"btn-{interval}", n_clicks=0, className="interval-btn") for interval in INTERVAL_DAYS.keys()],
